...
\begin{column}{0.35\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figure/sweaping_origin.pdf}
    % \caption{Original results (theory: red lines)}
\end{column}%
\begin{column}{0.65\linewidth}
	\centering
    \includegraphics[width=\linewidth]{figure/sweaping.png}
\end{column}
\end{columns}
\begin{itemize}
...
\begin{column}{0.6\linewidth}
	\centering
    \includegraphics[width=\textwidth]{figure/thermal.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\linewidth}
    \centering
    \only<1>{\includegraphics[width=\linewidth]{figure/erf=0.1,point6942.png}}
    \only<2>{\includegraphics[width=\linewidth]{figure/erf=20,point6898.8.png}}
\end{column}%
\begin{column}{0.5\linewidth}
	\centering
    \only<1>{\includegraphics[width=\linewidth]{figure/erf=0.1,point6942,wignar.png}}
    \only<2>{\includegraphics[width=\linewidth]{figure/erf=20,point6898.8,wignar.png}}
\end{column}
\end{columns}
\end{frame}
