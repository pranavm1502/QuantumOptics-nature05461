...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{cQED-atom.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{cavity.png}
\end{figure}
\tiny{\textcolor{gray}{Image from Blais, Alexandre, et al. "Cavity quantum electrodynamics for superconducting electrical circuits: An architecture for quantum computation." Physical Review A 69.6 (2004): 062320.\cite{blais2004cavity}}}
\end{frame}
...
\begin{column}{0.5\linewidth}
    \centering
    \only<1>{\includegraphics[width=0.9\linewidth]{erf=0.1,point6942.png}}
    \only<2>{\includegraphics[width=0.9\linewidth]{erf=20,point6898.8.png}}
\end{column}%
\begin{column}{0.5\linewidth}
	\centering
    \only<1>{\includegraphics[width=0.9\linewidth]{erf=0.1,point6942,wignar.png}}
    \only<2>{\includegraphics[width=0.9\linewidth]{erf=20,point6898.8,wignar.png}}
\end{column}
\end{columns}
\end{frame}
